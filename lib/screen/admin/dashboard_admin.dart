...
import 'package:project_if21b/controller/c_user.dart';
import 'package:project_if21b/event/event_pref.dart';
import 'package:project_if21b/model/user.dart';
import 'package:project_if21b/screen/admin/home_screen.dart';
...
class _DashboardAdminState extends State<DashboardAdmin> {
  // deklarasi variable untuk tampilan navbar
  ...
  //set user untuk menampilkan data dari event preference
